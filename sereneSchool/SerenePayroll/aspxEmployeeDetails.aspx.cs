    ...
    public partial class aspxEmployeeDetails : System.Web.UI.Page
    {
        ...
        protected void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                MySqlCommand cmd = new MySqlCommand("sereneschool.employee_delete", new MySqlConnection(GetConnectionString()));
        ...
        private Boolean EmployeeDtls_Update()
        {
            ...
            try
            {
                int v_txt_emp_code, v_pr_code, v_bnk_code, v_bbr_code, v_hm_code;
                ...
                */
                ...
                if (String.IsNullOrEmpty(txt_hm_code.Text))
                {
                    v_hm_code = 0;
                }
                else
                {
                    v_hm_code = Convert.ToInt32(txt_hm_code.Text);
                }

                try { v_co_code = Convert.ToInt32(ddl_emp_co_code.SelectedValue); }
                catch { v_co_code = 1; }
                ...
                MySqlCommand cmd = new MySqlCommand("sereneschool.employee_update", new MySqlConnection(GetConnectionString()));
                ...
                cmd.Parameters.Add(new MySqlParameter("v_pr_code", 0));
                cmd.Parameters.Add(new MySqlParameter("v_bnk_code", 0));
                cmd.Parameters.Add(new MySqlParameter("v_bbr_code", 0));
                cmd.Parameters.Add(new MySqlParameter("v_bank_acc_no", ' '));
                cmd.Parameters.Add(new MySqlParameter("v_hm_code", v_hm_code));
                cmd.Parameters.Add(new MySqlParameter("v_done_by", v_user));
                cmd.Parameters.Add(new MySqlParameter("v_co_code", v_co_code));
                cmd.Connection.Open();
                cmd.ExecuteNonQuery();
        ...
        protected Boolean EmployeeDtls_Import()
        {
            ...
            String strSubString;
            String v_user;
            int v_txt_emp_code, v_hm_code;
            int v_txt_emp_org_code;
            int v_cnt, v_pr_code, v_bnk_code, v_bbr_code, v_co_code;
            ...
            try
            {
                ...
                if (dt.Columns.Count != 0)
                {
                    foreach (DataRow row in dt.Rows)
                    {
                        ...
                        txt_hm_code.Text = row[23].ToString();
        ...
        protected void ListView1_ItemCommand(object sender, ListViewCommandEventArgs e)
        {
            ...
            try
            {
                ...
                Label emp_hm_codeLabel = (Label)e.Item.FindControl("emp_hm_codeLabel");
                Label emp_co_codeLabel = (Label)e.Item.FindControl("emp_co_codeLabel");
                ...
                txt_hm_code.Text = emp_hm_codeLabel.Text;
                ...
                try
                { ddl_emp_co_code.SelectedValue = emp_co_codeLabel.Text; }
                catch { ddl_emp_co_code.SelectedIndex = 1;  }
        ...
        protected void btnSaveEmpPhoto_Click(object sender, EventArgs e)
        {
            ...
            MySqlCommand cmd = new MySqlCommand("serenecrmsdb.update_human_photo", new MySqlConnection(GetConnectionString()));
            int v_txt_hm_code;
            v_user = System.Web.HttpContext.Current.User.Identity.Name;
            ...
            try
            {
                ...
                {
                    v_txt_hm_code = Convert.ToInt32(txt_hm_code.Text);
                }
                v_photo_stream = imgEmpPhoto.ImageUrl; // MyImageToBase64(imgEmpPhoto, System.Drawing.Imaging.ImageFormat.Bmp);
                System.Diagnostics.Debug.WriteLine("imgEmpPhoto Url="+ imgEmpPhoto.ImageUrl);

                cmd.CommandType = CommandType.StoredProcedure;
                cmd.Parameters.Add(new MySqlParameter("v_hm_code", v_txt_hm_code));
        ...
        protected void DispalyImgFromDb() {
            String errMessage;
            MySqlCommand cmd = new MySqlCommand("serenecrmsdb.get_human_photo", new MySqlConnection(GetConnectionString()));
        ...
        protected void ddl_emp_co_code_SelectedIndexChanged(object sender, EventArgs e)
        {
