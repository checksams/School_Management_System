...
namespace SerenePayroll
{
    ...
    public partial class aspxOrganization : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!this.IsPostBack)
            {
                DataTable dt = this.GetData("SELECT org_code, org_desc FROM serenefleet.fl_organizations where org_parent_org_code is null or org_parent_org_code = 0");
        ...
        protected void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            try {
                ...
                MySqlCommand cmd = new MySqlCommand("serenefleet.org_delete", new MySqlConnection(GetConnectionString()));
        ...
        private Boolean updateOrg()
        {
            ...
            try{
                ...
                MySqlCommand cmd = new MySqlCommand("serenefleet.update_org", new MySqlConnection(GetConnectionString()));
        ...
        private void PopulateTreeView(DataTable dtParent, int parentId, TreeNode treeNode)
        {
            foreach (DataRow row in dtParent.Rows)
            {
                ...
                if (parentId == 0)
                {
                    ...
                    DataTable dtChild = this.GetData("SELECT org_code, org_desc FROM serenefleet.fl_organizations WHERE org_parent_org_code = " + child.Value);
