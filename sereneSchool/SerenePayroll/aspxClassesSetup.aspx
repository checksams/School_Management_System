<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="aspxClassesSetup.aspx.cs" Inherits="SerenePayroll.aspxClassesSetup" %>
                ...
                <div  style="height:inherit;">
                    ...
                    <asp:Panel ID="pnlEditingData" runat="server" Wrap="False" Visible="true"
                        BackColor="#99CCFF">                
                            ...
                            <asp:Calendar ID="Calendar1" runat="server" Height="447px" Width="597px" OnSelectionChanged="Calendar1_SelectionChanged"></asp:Calendar>
