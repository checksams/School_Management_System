            ...
            <td>
                <div  style="height:inherit;">
                    ...
                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                        ...
                        SelectCommand="sereneschool.get_employees" SelectCommandType="StoredProcedure">
                        <SelectParameters>
                                    ...
                                    <td valign="top">
                                        <table style="width: 100%; ">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <asp:TextBox ID="txt_hm_code" runat="server" Width="217px" Enabled="false" Visible="false"> </asp:TextBox>
                                            ...
                                            <tr>
                                                ...
                                                <td class="auto-style1">
                                                    ...
                                                    <asp:SqlDataSource ID="SqlDataSource2" runat="server" 
                                                        ConnectionString="<%$ ConnectionStrings:serenehrdbConnectionString %>" 
                                                        ProviderName="<%$ ConnectionStrings:serenehrdbConnectionString.ProviderName %>" SelectCommand="SELECT org_code, org_desc FROM serenecrmsdb.cr_organizations WHERE (org_parent_org_code = 0) OR (org_parent_org_code IS NULL)"></asp:SqlDataSource>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                            ...
                                            <tr>
                                                <td>
                                                    <asp:Label ID="lblEmployeeOccupation" runat="server" Text="Employee Category : "></asp:Label>
                                                </td>
                                                <td>
                                                    <asp:DropDownList ID="ddl_emp_co_code" runat="server" Width="217px" 
                                                        DataSourceID="SqlDataSource3" DataTextField="co_sht_desc" 
                                                        DataValueField="co_code" AutoPostBack="True" OnSelectedIndexChanged="ddl_emp_co_code_SelectedIndexChanged" >
                                                    </asp:DropDownList>
                                                    <asp:SqlDataSource ID="SqlDataSource3" runat="server" ConnectionString="<%$ ConnectionStrings:serenehrdbConnectionString %>" ProviderName="<%$ ConnectionStrings:serenehrdbConnectionString.ProviderName %>" SelectCommand="select co_code,co_sht_desc,co_desc from serenecrmsdb.cr_occupations"></asp:SqlDataSource>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td rowspan="4">
                        ...
                        BackColor="#99CCF0">&nbsp;<asp:ListView ID="ListView1" runat="server" 
                            ...
                            <InsertItemTemplate>
                                <tr style="">
                                    ...
                                    <td style="visibility:collapse">
                                        <asp:TextBox ID="emp_hm_code" runat="server"  width="0px"
                                            Text='<%# Bind("emp_hm_code") %>' />
                                    </td>
                                    <td style="visibility:collapse">
                                        <asp:TextBox ID="emp_co_code" runat="server"  width="0px"
                                            Text='<%# Bind("emp_co_code") %>' />
                                    </td>
                                </tr>
                            </InsertItemTemplate>
                            <ItemTemplate>
                                <tr style="background-color: #E0FFFF;color: #333333;">
                                    ...
                                    <td style="visibility:collapse">
                                        <asp:Label ID="emp_hm_codeLabel" runat="server" 
                                            Text='<%# Eval("emp_hm_code") %>' />
                                    </td>
                                    <td style="visibility:collapse">
                                        <asp:Label ID="emp_co_codeLabel" runat="server" 
                                            Text='<%# Eval("emp_co_code") %>' />
                                    </td>
                                </tr>
                            </ItemTemplate>
                            ...
                            <EditItemTemplate>
                                <tr style="background-color: #999999;">
                                    ...
                                    <td style="visibility:collapse">
                                        <asp:TextBox ID="emp_hm_codeTextBox" runat="server"  width="0px"
                                            Text='<%# Bind("emp_hm_code") %>' />
                                    </td>
                                    <td style="visibility:collapse">
                                        <asp:TextBox ID="TextBox1" runat="server"  width="0px"
                                            Text='<%# Bind("emp_co_code") %>' />
                                    </td>
                                </tr>
                            </EditItemTemplate>
