    ...
    public partial class SiteMaster : System.Web.UI.MasterPage
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                else if (strURL == "aspxYearTerms.aspx")
                { strURL = "School Years and Terms"; }
                else if (strURL == "aspxDepartments.aspx")
                { strURL = "Departments"; }
                else if (strURL == "aspxClassesSetup.aspx")
                { strURL = "Classes Setup"; }
                else if (strURL == "aspxSubjects.aspx")
                { strURL = "Subjects"; }
                else if (strURL == "aspxSubjPClass.aspx")
                { strURL = "Subjects per Class"; }
                else if (strURL == "aspxTTSetup.aspx")
                { strURL = "Time Table Setup"; }
                else if (strURL == "aspxEvents.aspx")
                { strURL = "Events"; }
                ...
                { strURL = "Pay Elements"; }
                else if (strURL == "aspxDestinations.aspx")
                { strURL = "Destinations"; }
                else if (strURL == "aspxRoutes.aspx")
                { strURL = "Routes"; }
                else if (strURL == "aspxVehicles.aspx")
                { strURL = "Vehicles"; }
                else if (strURL == "aspxPrices.aspx")
                { strURL = "Transport Prices"; }
                else if (strURL == "aspxParcelCategories.aspx")
                { strURL = "Parcel Categories"; }
                else if (strURL == "aspxParcelPriceList.aspx")
                { strURL = "Parcel Pricelists"; }
                else if (strURL == "aspxDepartures.aspx")
                { strURL = "Departures"; }
                else if (strURL == "aspxArrivals.aspx")
                { strURL = "Arrivals"; }
                else if (strURL == "aspxPassengersCapture.aspx")
                { strURL = "Passengers Capture"; }
                else if (strURL == "aspxParcelCapture.aspx")
                { strURL = "Parcel Capture"; }
                else if (strURL == "aspxTemplate.aspx")
                { strURL = "Templates"; }
        ...
        protected void ProcAccessRoles() {
            ...
            try
            {
                ...
                MySqlCommand cmd = new MySqlCommand("serenefleet.get_curr_user_priv", new MySqlConnection(GetConnectionString()));
                ...
                cmd.Dispose();
                System.Diagnostics.Debug.WriteLine("Processing roles============================");
