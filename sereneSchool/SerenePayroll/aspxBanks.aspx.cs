    ...
    public partial class aspxBanks : System.Web.UI.Page
    {
        ...
        {            
            ...
            try
            {
                ...
                MySqlCommand cmd = new MySqlCommand("serenefleet.delete_banks", new MySqlConnection(GetConnectionString()));
        ...
        private Boolean Bank_Update() {
            ...
            try {
                ...
                MySqlCommand cmd = new MySqlCommand("serenefleet.update_banks", new MySqlConnection(GetConnectionString()));
        ...
        private Boolean BankBranch_Update()
        {
            ...
            try
            {
                ...
                cmd = new MySqlCommand("serenefleet.update_bank_branches", new MySqlConnection(GetConnectionString()));
        ...
        protected void GridView2_RowDeleting(object sender, GridViewDeleteEventArgs e)
        {
            ...
            cmd = new MySqlCommand("serenefleet.delete_bank_branches", new MySqlConnection(GetConnectionString()));
            ...
            {   MySqlCommand cmd;
                ...
                if (dt.Columns.Count != 0)
                {
                    foreach (DataRow row in dt.Rows)
                    {
                        ...
                        cmd = new MySqlCommand("serenefleet.update_banks", new MySqlConnection(GetConnectionString()));
        ...
        protected void btnDeleteAll_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                try
                {
                    ...
                    MySqlCommand cmd = new MySqlCommand("serenefleet.delete_all_bank_branches", new MySqlConnection(GetConnectionString()));
                    System.Diagnostics.Debug.WriteLine("v_txtBnkCode =====>" + v_txtBnkCode);
                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.Parameters.Add(new MySqlParameter("v_bnk_code", v_txtBnkCode));
                    cmd.Connection.Open();
        ...
        protected void btnDeleteAllBankDtls_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                MySqlCommand cmd = new MySqlCommand("serenefleet.delete_all_bank_details", new MySqlConnection(GetConnectionString()));
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.Connection.Open();
                cmd.ExecuteNonQuery();
                cmd.Connection.Close();
