    ...
    public partial class aspxSystemRoles : System.Web.UI.Page
    {
        ...
        {            
            ...
            try
            {
                ...
                MySqlCommand cmd = new MySqlCommand("serenefleet.delete_user_roles", new MySqlConnection(GetConnectionString()));
        ...
        private Boolean Privillage_Update()
        {
            ...
            try
            {
                ...
                MySqlCommand cmd = new MySqlCommand("serenefleet.update_user_roles", new MySqlConnection(GetConnectionString()));
        ...
        protected void btnGrant_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                foreach (GridViewRow row in GridView2.Rows)
                {
                    ...
                    {
                        cmd = new MySqlCommand("serenefleet.update_user_role_privlg", new MySqlConnection(GetConnectionString()));
        ...
        protected void btnRevoke_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                foreach (GridViewRow row in GridView3.Rows)
                {
                    ...
                    {
                        cmd = new MySqlCommand("serenefleet.delete_user_role_privlg", new MySqlConnection(GetConnectionString()));
