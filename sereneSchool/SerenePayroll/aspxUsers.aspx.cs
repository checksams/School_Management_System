    ...
    public partial class aspxUsers : System.Web.UI.Page
    {
        ...
        {            
            ...
            try
            {
                ...
                MySqlCommand cmd = new MySqlCommand("serenefleet.delete_user", new MySqlConnection(GetConnectionString()));
        ...
        private Boolean User_Update()
        {
            ...
            try
            {
                ...
                MySqlCommand cmd = new MySqlCommand("serenefleet.update_users", new MySqlConnection(GetConnectionString()));
        ...
        protected void btnGrant_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                foreach (GridViewRow row in GridView2.Rows)
                {
                    ...
                    {
                        cmd = new MySqlCommand("serenefleet.update_user_roles_granted", new MySqlConnection(GetConnectionString()));
        ...
        protected void btnRevoke_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                foreach (GridViewRow row in GridView3.Rows)
                {
                    ...
                    {
                        cmd = new MySqlCommand("serenefleet.delete_user_roles_granted", new MySqlConnection(GetConnectionString()));
