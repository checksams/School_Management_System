<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="aspxTTSetup.aspx.cs" Inherits="SerenePayroll.aspxTTSetup" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript">
        ...
        function MyJavaFun(title, msg) {
            //alert("This is another function bbbbbbbbbbbbb.");
            var orignalstring = document.getElementById("msgbox2").innerHTML;
            var newstring = orignalstring.replace("[TITLE]", title);
            document.getElementById("msgbox2").innerHTML = newstring;

            orignalstring = document.getElementById("msgbox2").innerHTML;
            newstring = orignalstring.replace("[MESSAGE]", msg);
            document.getElementById("msgbox2").innerHTML = newstring;

            document.getElementById('pagedimmer2').style.visibility = 'visible';
            document.getElementById('pagedimmer2').style.display = 'inline';
            document.getElementById('msgbox2').style.visibility = 'visible';
            document.getElementById('msgbox2').style.display = 'inline';
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="page_dimmer" id="pagedimmer2" style="display:none "> </div> 
    <div class="msg_box_container" id="msgbox2" style="display:none "> 
    <table class="errorTableRound" cellpadding="5"> 
    <tr style="background-color:inherit;
            border-top-left-radius: 20px;
            border-top-right-radius: 20px;
    ...
    <td colspan="1">
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <td colspan="1">
        <asp:Button ID="aspBtnSaveEvent" runat="server" OnClick="tdTT_Click" Text="Save" />
        <input type="Button" value="Cancel" 
        onClick="document.getElementById('pagedimmer2').style.visibility = 'hidden';
    document.getElementById('msgbox2').style.visibility = 'hidden'"></td> 
    </tr> 
    </table> 
    </div> 
        ...
        <tr style="height:inherit; vertical-align:top">
                     ...
                     <table style="width:100%;">
                        <tr><td>
                            <asp:Button ID="btnSearch" runat="server" Text="Search" 
                             ...
                             <asp:Button ID="btnEventPopup" runat="server" Text="Event Popup" OnClick="btnEventPopup_Click" />
                            </br>
                             <asp:Button ID="Popup" runat="server" Text="Popup" OnClick="Popup_Click"  width="200px"
            ...
            <td>
                <div  style="height:inherit;">
                    ...
                    <asp:Panel ID="pnlTimeTable" runat="server" Wrap="False" Visible="true"
                        BackColor="#99CCFF">  
                        <table ID="tblTTMonthx" runat="server" style="width:95%; text-align:center; border-color:black; border-spacing:0"  border="1" 
                             cellspacing="0" cellpadding="1" class="CalTable">
                                ...
                                <td colspan="7" style="width:100%">
                                    <table style="width:100%">
                                        <tr>
                                            ...
                                            <td style="width:95%; text-align:center; " colspan="5">
                                                <asp:Label ID="lblMonth" runat="server" Text="Month Year" Font-Bold="true"></asp:Label>
                                            </td>
                                            <td> >
                                            </td>
                                        </tr>
                            ...
                            <tr style="background-color:#c4c3bb; border:thin; ">
                                <td ID="tdSun" runat="server" >
                                    <asp:Label ID="lblSun" runat="server" Text="Sun" Font-Bold="true" ></asp:Label>
                                </td>
                                <td ID="tdMon" runat="server">
                                    <asp:Label ID="lblMon" runat="server" Text="Mon" Font-Bold="true"></asp:Label>
                                </td>
                                <td ID="tdTue" runat="server">
                                    <asp:Label ID="lblTue" runat="server" Text="Tue" Font-Bold="true"></asp:Label>
                                </td>
                                <td ID="tdWed" runat="server">
                                    <asp:Label ID="lblWed" runat="server" Text="Wed" Font-Bold="true"></asp:Label>
                                </td>
                                <td ID="tdThu" runat="server">
                                    <asp:Label ID="lblThu" runat="server" Text="Thu" Font-Bold="true"></asp:Label>
                                </td>
                                <td ID="tdFri" runat="server">
                                    <asp:Label ID="lblFri" runat="server" Text="Fri" Font-Bold="true"></asp:Label>
                                </td>
                                <td ID="tdSat" runat="server" >
                                    <asp:Label ID="lblSat" runat="server" Text="Sat" Font-Bold="true"></asp:Label>
                                    <input id="Button2" type="button" value="button" onclick="MyJavaFunction('sdsdg', 'messgeeee')" visible="false" />
                                    <asp:Button ID="Label1" runat="server" Text="Sat" Font-Bold="true"
                                         OnClientClick="MyJavaFunction('sdsdg', 'messgeeee')" Visible="false"></asp:Button>
                                </td>
                        ...
                        <PopupWindow runat="server">
                            ...
                            <ASPP:PopupWindow ID="PopupWindow3" runat="server">
                                <div align="center" style="width: 500px; height: 300px">
                                    <asp:Label ID="Label2" runat="server">nnnnnnn</asp:Label>
                                    <br />
                                    <asp:TextBox ID="TextBox1" AutoPostBack="true"
                                    runat="server"></asp:TextBox>

                                    <asp:Button ID="in" runat="server" Text="btnx" />
